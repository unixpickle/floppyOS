...
bin/kernel: bin/testprog bin/pit.o bin/interrupt.o bin/idtload.o bin/floppyasm.o bin/floppyc.o bin/dma.o bin/simplefloppy.o bin/keyboard.o bin/tasks.o
	...
	ld bin/kernentry.o bin/kmain.o bin/kstdio.o bin/launch.o bin/kstdlib.o bin/kpi.o bin/picinit.o bin/idtinit.o bin/idtload.o bin/interrupt.o bin/pit.o bin/floppyc.o bin/floppyasm.o bin/dma.o bin/simplefloppy.o bin/keyboard.o bin/tasks.o -Ttext 0x1000 -e kentry --oformat binary -s -o bin/kernel
